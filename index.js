...
var text = fs.readFileSync("./mensaje.txt",{encoding:'utf8', flag:'r'});
...
// app.get('/api', (req, res)=>{
//     res.json({
//         message: "this is from express",
//         title: "this is title from express"
//     //mensaje
//     })
// })
const getRiver = ()=> {
...
app.get('/api/rocja',(req, res) =>{
    ...
    res.json({
        results: rocjaData,
        image: '/home/matt_linux/DigitalCraftsNew/express-api-demo/P21011011265810.jpg'
    })
})
